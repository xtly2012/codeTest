...
public class TempUrlClassLoader extends URLClassLoader
{

    String baseUrl = "D:/workspace/Test/build/";  
     ...
     * @param urls 
     */  
    public TempUrlClassLoader(URL[] urls) {  
        super(urls);  
    }  
     ...
     * @param parent 
     */  
    public TempUrlClassLoader(URL[] urls, ClassLoader parent) {  
        super(urls,parent);  
    }  
